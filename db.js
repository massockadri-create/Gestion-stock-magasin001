...
// ---------------------------------------------------------------------------
// Migrations légères : ajout de colonnes sur des bases déjà en production.
// SQLite n'a pas de "ADD COLUMN IF NOT EXISTS" — on tente et on ignore
// l'erreur "duplicate column name" si la colonne existe déjà.
// ---------------------------------------------------------------------------
...
// Type de conditionnement par produit :
//  - 'cahier'     : carton -> paquet -> pièce   (paquet_par_carton, piece_par_paquet)
//  - 'accessoire' : carton -> box -> paquet -> pièce (box_par_carton, paquet_par_box, piece_par_paquet)
//  - 'livre'      : carton -> pièce directement (piece_par_carton)
ajouterColonneSiAbsente('produits', 'type_conditionnement', "TEXT NOT NULL DEFAULT 'cahier'");
ajouterColonneSiAbsente('produits', 'box_par_carton', 'INTEGER');
ajouterColonneSiAbsente('produits', 'paquet_par_box', 'INTEGER');
ajouterColonneSiAbsente('produits', 'piece_par_carton', 'INTEGER');

// Niveau "box", nécessaire uniquement pour les accessoires (carton > box > paquet > pièce)
ajouterColonneSiAbsente('entrees', 'qte_box', 'INTEGER NOT NULL DEFAULT 0');
ajouterColonneSiAbsente('sorties', 'qte_box', 'INTEGER NOT NULL DEFAULT 0');
